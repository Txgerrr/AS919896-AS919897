...
#make sure there is only 1 order id of a number at a time
def unique_orderid():
    #until unique id is found, generate random number
    while True:
        unique_id = random.randint(1000,9999)
        #if unique number is found, check used_ids from same number, if its a unique number, add to used_ids list
...
def hire_window():
    ...
    user_info_frame = tk.LabelFrame(frame, text="Hire - User Information", bg="#ccf2cc", fg="black", font=title_font)
...
def return_window():
    ...
    user_return_frame = tk.LabelFrame(frame, text="Return - User Information", bg="#ccf2cc", fg="black", font=title_font)
    ...
    tk.Button(user_return_frame, text="Submit", width=label_width, command=submit_return, bg="#f0f0f0", fg="black", font=custom_font).grid(row=5, column=1, pady=10, padx=30)
    tk.Button(user_return_frame, text="Home", width=label_width, command=return1.destroy, bg="#f0f0f0", fg="black", font=custom_font).grid(row=5, column=0, pady=10, padx=30)
...
Button(frame_main, text="Return", command=return_window, width=other_width, bg="#f0f0f0", fg="black", font=custom_font).grid(row=2, column=0, padx=60, pady=10)
Button(frame_main, text="View Receipts", command=stored_info, width=other_width, bg="#f0f0f0", fg="black", font=custom_font).grid(row=3, column=0, padx=60, pady=10)
Button(frame_main, text="Quit", command=quit_program, width=other_width, bg="#f0f0f0", fg="black", font=custom_font).grid(row=4, column=0, padx=60, pady=10)
